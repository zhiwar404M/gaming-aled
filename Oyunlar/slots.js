...
.setDescription(`<a:emoji_32:870319275263533107> The amount you entered is not a valid number !?`))
 let kazandin = miktar*3   
  let slots = ["<:srandom:878415028510933062>","<:slots2:878401761788977162>","<:slots3:878401708512927774>","<:AAblank_box:872905535698137138>"];
  //
//== BEERCODE (https://discord.gg/ew3dpTu4Z5) BEERCODE ==\\
...
//===BEERCODE (https://discord.gg/ew3dpTu4Z5) BEERCODE ==\\ 
  if (slots[result1] === slots[result2] && slots[result2] === slots[result3] ) {
    var text2 = `**
 **__SLOTS__**  
 <a:slots7:878401859818225706><a:slots7:878401859818225706><a:slots7:878401859818225706>|${message.author.username}
|          | **`;
          message.channel.send(text2).then(msg => {
            setTimeout(() => {
              msg.edit(`**
 **__SLOTS__**  
 ${slots[result1]}${slots[result2]}${slots[result3]}${message.author.username} <:rcash2:878753234175553587> ${kazandin}+
|          | **`,true);
            }, 3500);
          });
...
|          | **`;
          message.channel.send(text3).then(msg => {
            setTimeout(() => {
              msg.edit(`**
 **__SLOTS__**  
 ${slots[result1]}${slots[result2]}${slots[result3]}|${message.author.username} <:rcash2:878753234175553587> ${miktar}-
|          |**`, true);
            }, 3500);
          });
